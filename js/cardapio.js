const pizzas = [
  ...
  function renderizarCardapio() {
    ...
    pizzas.forEach(pizza => {
      ...
      card.innerHTML =  `
        ...
        <p class="pizza-tamanho">Tamanho único</p>
  ...
  // Busca pizzas exibindo/ocultando cards
  ...
  // Funções de carrinho (igual ao que você já tem)
  ...
  function finalizarPedido() {
    ...
    alert(`Pedido finalizado! Total: R$ ${totalSpan.textContent}`);
    carrinho = [];
    atualizarCarrinho();
  }
